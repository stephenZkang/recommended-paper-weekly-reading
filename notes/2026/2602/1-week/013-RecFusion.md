...
**一、旧技术（基础复用，回归本质逻辑）**：
1.  多模态基础：ViT（图像编码）、BERT（文本编码）、CLIP（跨模态对齐）——旧技术核心作用：提供单模态编码与跨模态对齐的基础能力，RecFusion在其基础上优化适配推荐场景；
2.  推荐基础模型：LightGCN、SASRec——旧技术核心作用：提供推荐精度的基线方法，用于对比验证RecFusion的优势；
3.  对比学习基础：InfoNCE损失、MoCo——旧技术核心作用：提供跨模态一致性增强的基础方法，RecFusion将其融入推荐损失；
    **二、新技术（核心创新，直击本质痛点）**：
1.  多模态统一编码器：RecFusion提出的核心新技术——将不同模态映射到同一语义空间，消除语义错位，解决“表征割裂”的本质问题；
2.  自适应门控融合模块：RecFusion提出的核心新技术——动态加权模态贡献，捕捉复杂关联，解决“融合低效”的本质问题；
3.  推荐专用跨模态对比损失：RecFusion提出的核心新技术——结合推荐任务，增强模态一致性，提升泛化与冷启动；
