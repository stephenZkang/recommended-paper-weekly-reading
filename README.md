...
## d. 论文周报[0908-0914] (12篇)

| # | 论文标题 (Title)                                                                                                                                                                      | 作者 & 年份                                    |   状态   |                       我的笔记                        |
|:-:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------|:------:|:-------------------------------------------------:|
| 1 | [CESRec: Constructing Pseudo Interactions for Sequential Recommendation via Conversational Feedback](https://arxiv.org/abs/2509.09342) <br/>论文核心：CESRec会话增强序列推荐框架                 | Yifan Wang,<br /> 2025                     | ⬜️ 未读  |      [笔记](notes/2509/4-week/001-ces-rec.md)       |
| 2 | [Modality Alignment with Multi-scale Bilateral Attention for Multimodal Recommendation](https://arxiv.org/abs/2509.09114)  <br/>论文核心：MambaRec多模态推荐框架                              | Xiaoxiao Xu,<br /> 2025                    | ⬜️ 未读  |     [笔记](notes/2509/4-week/002-mamba-rec.md)      |
| 3 | [PerFairX: Is There a Balance Between Fairness and Personality in Large Language Model Recommendations?](https://arxiv.org/abs/2509.08829) <br/>论文核心：PerFairX框架（LLM推荐的人格-公平评估）    | Chandan Kumar Sah <br />2025               | ⬜️ 未读  |      [笔记](notes/2509/4-week/003-perfairx.md)      |
| 4 | [Beyond Negative Transfer: Disentangled Preference-Guided Diffusion for Cross-Domain Sequential Recommendation](https://arxiv.org/abs/2509.00389) <br/> 论文核心：DPG-Diff（跨域序列推荐扩散模型） | Xiaoxin Ye,2025                            | ⬜️ 未读  |      [笔记](notes/2509/4-week/004-dpg-diff.md)      |
| 5 | [Datasets for Navigating Sensitive Topics in Recommendation Systems](https://arxiv.org/abs/2509.07269) <br/>论文核心：敏感话题推荐数据集（ML-DDD&AO3）                                            | Amelia Kovacs, 2025                        | ⬜️ 未读  |       [笔记](notes/2509/4-week/005-ml-ddd.md)       |
| 6 | [RecMind: LLM-Enhanced Graph Neural Networks for Personalized Consumer Recommendations](https://arxiv.org/abs/2509.06286) <br/>论文核心：RecMind（LLM增强GNN推荐模型）                         | Chang Xue, 2025                            | ⬜️ 未读  |      [笔记](notes/2509/4-week/006-recmind.md)       |
| 7 | [REMI: A Novel Causal Schema Memory Architecture for Personalized Lifestyle Recommendation Agents](https://arxiv.org/abs/2509.06269) <br/>论文核心：FedRec4CPS（CPS联邦推荐框架）              | Vishal Raman, 2025                         | ⬜️ 未读  |     [笔记](notes/2509/4-week/007-redrec4cps.md)     |
| 8 | [ARIES: Relation Assessment and Model Recommendation for Deep Time Series Forecasting](https://arxiv.org/abs/2509.06060) <br/>论文核心：ARIES（时间序列预测框架）                                | Fei Wang, Yujie Li, <br />2025             | ⬜️ 未读  |       [笔记](notes/2509/4-week/008-AREIS.md)        |
| 9 | [Knowledge-Augmented Relation Learning for Complementary Recommendation with Large Language Models](https://arxiv.org/abs/2509.05564)<br/>论文核心：KARL框架（互补推荐的知识增强关系学习）              | Chihiro Yamasaki, 2025                     | ⬜️ 未读  |        [笔记](notes/2509/4-week/009-KAKL.md)        |
| 10 | [Calibrated Recommendations with Contextual Bandits](https://arxiv.org/abs/2509.05460)<br/>论文核心：Spotify的上下文老虎机校准推荐                                                                | Diego Feijer, 2025                         |⬜️ 未读   | [笔记](notes/2509/4-week/010-Contextual-Bandits.md) |
| 11 | [A Survey of Real-World Recommender Systems: Challenges, Constraints, and Industrial Perspectives](https://arxiv.org/abs/2509.06002) <br/> 论文核心：工业推荐系统综述（产学差距与实践指南）               | Kuan Zou, 2025                             | ⬜️ 未读  |   [笔记](notes/2509/4-week/011-RecSys-Survey.md)    |
| 12 | [ELEC: Efficient Large Language Model-Empowered Click-Through Rate Prediction](https://arxiv.org/abs/2509.07594) <br/> 论文核心：ELEC（高效LLM增强CTR预测框架）                                  | Rui Dong, 2025                             | ⬜️ 未读  |        [笔记](notes/2509/4-week/012-ELEC.md)        |
