...
## d. 论文周报[0922-0928] (12篇)

| # | 论文标题 (Title)                                                                                                                                                                             | 作者 & 年份                      |   状态   |                       我的笔记                        |
|:-:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------|:------:|:-------------------------------------------------:|
| 1 | [Interactive Recommendation Agent with Active User Commands](https://arxiv.org/abs/2509.21317) <br/>论文核心：CESRec会话增强序列推荐框架                                                                | Jiakai Tang,<br /> 2025      | ⬜️ 未读  |      [笔记](notes/2509/4-week/001-ces-rec.md)       |
| 2 | [IntSR: An Integrated Generative Framework for Search and Recommendation](https://arxiv.org/abs/2509.21179)  <br/>论文核心：MambaRec多模态推荐框架                                                   | Huimin Yan,<br /> 2025         | ⬜️ 未读  |     [笔记](notes/2509/4-week/002-mamba-rec.md)      |
| 3 | [RecIS: Sparse to Dense, A Unified Training Framework for Recommendation Models](https://arxiv.org/abs/2509.20883) <br/>论文核心：PerFairX框架（LLM推荐的人格-公平评估）                                   | Hua Zong,  <br />2025       | ⬜️ 未读  |      [笔记](notes/2509/4-week/003-perfairx.md)      |
| 4 | [USB-Rec: An Effective Framework for Improving Conversational Recommendation Capability of Large Language Model](https://arxiv.org/abs/2509.20381) <br/> 论文核心：DPG-Diff（跨域序列推荐扩散模型）    | Jianyu Wen,2025                | ⬜️ 未读  |      [笔记](notes/2509/4-week/004-dpg-diff.md)      |
| 5 | [Multimodal Representation-disentangled Information Bottleneck for Multimodal Recommendation](https://arxiv.org/abs/2509.20225) <br/>论文核心：敏感话题推荐数据集（ML-DDD&AO3）                        | Hui Wang, 2025                 | ⬜️ 未读  |       [笔记](notes/2509/4-week/005-ml-ddd.md)       |
| 6 | [Multimodal-enhanced Federated Recommendation: A Group-wise Fusion Approach](https://arxiv.org/abs/2509.19955) <br/>论文核心：RecMind（LLM增强GNN推荐模型）                                           | Chunxu Zhang, 2025             | ⬜️ 未读  |      [笔记](notes/2509/4-week/006-recmind.md)       |
| 7 | [MusiCRS: Benchmarking Audio-Centric Conversational Recommendation](https://arxiv.org/abs/2509.19469) <br/>论文核心：FedRec4CPS（CPS联邦推荐框架）                                                    | Rohan Surana, 2025            | ⬜️ 未读  |     [笔记](notes/2509/4-week/007-redrec4cps.md)     |
| 8 | [Single-Branch Network Architectures to Close the Modality Gap in Multimodal Recommendation](https://arxiv.org/abs/2509.18807) <br/>论文核心：ARIES（时间序列预测框架）                                | Christian Ganhör, <br />2025  | ⬜️ 未读  |       [笔记](notes/2509/4-week/008-AREIS.md)        |
| 9 | [Rejuvenating Cross-Entropy Loss in Knowledge Distillation for Recommender Systems](https://arxiv.org/abs/2509.20989)<br/>论文核心：KARL框架（互补推荐的知识增强关系学习）                                | Zhangchi Zhu, 2025            | ⬜️ 未读  |        [笔记](notes/2509/4-week/009-KAKL.md)        |
| 10 | [Robust Denoising Neural Reranker for Recommender Systems](https://arxiv.org/abs/2509.18736)<br/>论文核心：Spotify的上下文老虎机校准推荐                                                               | Wenyu Mao,  2025             |⬜️ 未读   | [笔记](notes/2509/4-week/010-Contextual-Bandits.md) |
