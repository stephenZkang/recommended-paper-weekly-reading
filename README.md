...
| # | 论文标题 (Title)                                                                                                                                                    | 作者 & 年份                                           |  状态   |                       我的笔记                        |
|:-:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------|:-----:|:-------------------------------------------------:|
| 1 | [Enhancing Time Awareness in Generative Recommendation](https://arxiv.org/abs/2509.13957) <br/>  论文核心：GRUT（增强时间感知的生成式推荐模型）                          | Sunkyung Lee,<br /> 2025                          | ⬜️ 未读 |      [笔记](notes/2509/3-week/001-GRUT)       |
| 2 | [MIRA: Empowering One-Touch AI Services on Smartphones with MLLM-based Instruction Recommendation](https://arxiv.org/abs/2509.13773)  <br/>                     | Zhipeng Bian,<br /> 2025                          | ⬜️ 未读 |     [笔记](notes/2509/3-week/002-mamba-rec.md)      |
| 3 | [Sequential Data Augmentation for Generative Recommendation](https://arxiv.org/abs/2509.13648) <br/>                                                            | Geon Lee <br />2025                               | ⬜️ 未读 |      [笔记](notes/2509/3-week/003-perfairx.md)      |
| 4 | [Efficient Cold-Start Recommendation via BPE Token-Level Embedding Initialization with LLM](https://arxiv.org/abs/2509.13179) <br/>                             | Yushang Zhao,2025                                 | ⬜️ 未读 |      [笔记](notes/2509/3-week/004-dpg-diff.md)      |
| 5 | [LLM-as-a-Judge: Rapid Evaluation of Legal Document Recommendation for Retrieval-Augmented Generation](https://arxiv.org/abs/2509.12382) <br/>                  | Anu Pradhan, 2025                                 | ⬜️ 未读 |       [笔记](notes/2509/3-week/005-ml-ddd.md)       |
| 6 | [Knowledge Graph Tokenization for Behavior-Aware Generative Next POI Recommendation](https://arxiv.org/abs/2509.12350) <br/>                                    | Ke Sun, 2025                                      | ⬜️ 未读 |      [笔记](notes/2509/3-week/006-recmind.md)       |
