...
## a. 论文周报[1103-1109] (10篇)

| # | 论文标题 (Title)                                                                                                                                                                               | 作者 & 年份                  |   状态   |                       我的笔记                       |
|:-:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------|:------:|:------------------------------------------------:|
| 1 | [LLM-as-a-Judge: Toward World Models for Slate Recommendation Systems](https://arxiv.org/abs/2511.04541)<br/> 论文核心：Prompt-as-Policy——知识图谱驱动的冷启动POI推荐框架                                     | Baptiste Bonin,2025      | ⬜️ 未读  | [笔记](notes/2511/1-week/001-Prompt-as-Policy.md)  |
| 2 | [Denoised Recommendation Model with Collaborative Signal Decoupling](https://arxiv.org/abs/2511.04237)<br/> 论文核心：MMM框架——量子化学分子表示学习用于组合药物推荐                                                 | Zefeng Li,2025           | ⬜️ 未读  |        [笔记](notes/2511/1-week/002-MMM.md)        |
| 3 | [Discourse-Aware Scientific Paper Recommendation via QA-Style Summarization and Multi-Level Contrastive Learning](https://arxiv.org/abs/2511.03330)   <br/> 论文核心：PLUM——适配预训练LLM的工业级生成式推荐框架 | Shenghua Wang, 2025      | ⬜️ 未读  |       [笔记](notes/2511/1-week/003-PLUM.md)        |
| 4 | [Generative Sequential Recommendation via Hierarchical Behavior Modeling](https://arxiv.org/abs/2511.03155) <br/>  论文核心：Retentive Relevance（RR）——推荐系统的长期用户价值指标                             | Zhefan Wang,2025         | ⬜️ 未读  |        [笔记](notes/2511/1-week/004-RR.md)         |
| 5 | [No-Human in the Loop: Agentic Evaluation at Scale for Recommendation](https://arxiv.org/abs/2511.03051) <br/> 论文核心：LLM驱动的视频属性标注增强推荐系统                                                     | Tao Zhang, 2025          |  ⬜️ 未读 | [笔记](notes/2511/1-week/005-LLM-as-annotators.md) |
| 6 | [KGBridge: Knowledge-Guided Prompt Learning for Non-overlapping Cross-Domain Recommendation](https://arxiv.org/abs/2511.02181) <br/> 论文核心：XRec框架的可复现性研究（LLM驱动可解释推荐）                        | Yuhan Wang, 2025         | ⬜️ 未读  |       [笔记](notes/2511/1-week/006-XRec.md)        |
| 7 | [Enhancing Multimodal Recommendations with Vision-Language Models and Information-Aware Fusion](https://arxiv.org/abs/2511.02113) <br/> 论文核心：RouteLLM——自然语言驱动的约束感知路线推荐框架                   | Hai-Dang Kieu, 2025      | ⬜️ 未读  |     [笔记](notes/2511/1-week/007-RouteLLM.md)      |
| 8 | [Solving Cold Start in News Recommendations: a RippleNet-based System for Large Scale Media Outlet](https://arxiv.org/abs/2511.02052) <br/>   论文核心：AgentDR——LLM代理驱动的隐式物品关系推荐框架             | Karol Radziszewski, 2025 | ⬜️ 未读  |      [笔记](notes/2511/1-week/008-AgentDR.md)      |
