...
|:--:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------|:-------:|:------------------------------------------------:|
| 1  | [Causality Enhancement for Cross-Domain Recommendation](https://arxiv.org/abs/2510.14641)<br/> 论文核心：Prompt-as-Policy——知识图谱驱动的冷启动POI推荐框架        | Zhibo Wu,2025           |  ✅ 已读   | [笔记](notes/2510/2-week/001-Prompt-as-Policy.md)  |
| 2  | [MR.Rec: Synergizing Memory and Reasoning for Personalized Recommendation Assistant with LLMs](https://arxiv.org/abs/2510.14629)<br/> 论文核心：MMM框架——量子化学分子表示学习用于组合药物推荐                      | Jiani Huang,2025        |  ✅ 已读   |        [笔记](notes/2510/2-week/002-MMM.md)        |
| 3  | [GemiRec: Interest Quantization and Generation for Multi-Interest Recommendation](https://arxiv.org/abs/2510.14626)   <br/> 论文核心：PLUM——适配预训练LLM的工业级生成式推荐框架                        | Ruining He, 2025        |  ✅ 已读   |       [笔记](notes/2510/1-week/003-PLUM.md)        |
| 4  | [Synergistic Integration and Discrepancy Resolution of Contextualized Knowledge for Personalized Recommendation](https://arxiv.org/abs/2510.14257) <br/>  论文核心：Retentive Relevance（RR）——推荐系统的长期用户价值指标                          | Lingyu Mu,2025          |  ✅ 已读   |        [笔记](notes/2510/2-week/004-RR.md)         |
| 5  | [HyMiRec: A Hybrid Multi-interest Learning Framework for LLM-based Sequential Recommendation](https://arxiv.org/abs/2510.13738) <br/> 论文核心：LLM驱动的视频属性标注增强推荐系统                                                 | Jingyi Zhou, 2025       |  ✅ 已读   | [笔记](notes/2510/2-week/005-LLM-as-annotators.md) |
| 6  | [MADREC: A Multi-Aspect Driven LLM Agent for Explainable and Adaptive Recommendation](https://arxiv.org/abs/2510.13371) <br/> 论文核心：XRec框架的可复现性研究（LLM驱动可解释推荐）                              | Jiin Park, 2025         |  ✅ 已读   |       [笔记](notes/2510/2-week/006-XRec.md)        |
| 7  | [Improving Visual Recommendation on E-commerce Platforms Using Vision-Language Models](https://arxiv.org/abs/2510.13359) <br/> 论文核心：RouteLLM——自然语言驱动的约束感知路线推荐框架                                  | Yuki Yada, 2025         |  ✅ 已读   |     [笔记](notes/2510/2-week/007-RouteLLM.md)      |
| 8  | [Beyond Static LLM Policies: Imitation-Enhanced Reinforcement Learning for Recommendation](https://arxiv.org/abs/2510.13229) <br/>   论文核心：AgentDR——LLM代理驱动的隐式物品关系推荐框架                           | Yi Zhang, 2025      |  ✅ 已读   |      [笔记](notes/2510/2-week/008-AgentDR.md)      |
| 9  | [Maximum In-Support Return Modeling for Dynamic Recommendation with Language Model Prior](https://arxiv.org/abs/2510.12816) <br/>   论文核心：IDIOMoE——解决LLM推荐知识纠缠的混合专家模型                           | Xiaocong Chen, 2025   |  ✅ 已读   |      [笔记](notes/2510/2-week/009-IDIOMoE.md)      |
| 10 | [Energy-Guided Diffusion Sampling for Long-Term User Behavior Prediction in Reinforcement Learning-based Recommendation](https://arxiv.org/abs/2510.12815) <br/> 论文核心：推荐系统中新颖物品的安全探索框架（Safe OPG + DEPSUE）          | Xiaocong Chen, 2025   |  ✅ 已读   |     [笔记](notes/2510/2-week/010-Safe-OPG.md)      |
| 11 | [Causal Inspired Multi Modal Recommendation](https://arxiv.org/abs/2510.12325) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Jie Yang, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 12 | [Reinforced Preference Optimization for Recommendation](https://arxiv.org/abs/2510.12211) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Junfei Tan, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 13 | [OneRec-Think: In-Text Reasoning for Generative Recommendation](https://arxiv.org/abs/2510.11639) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Zhanyu Liu, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 14 | [Differentiable Fast Top-K Selection for Large-Scale Recommendation](https://arxiv.org/abs/2510.11472) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Yanjie Zhu, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 15 | [On Inherited Popularity Bias in Cold-Start Item Recommendation](https://arxiv.org/abs/2510.11402) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Gregor Meehan, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 16 | [Post-hoc Popularity Bias Correction in GNN-based Collaborative Filtering](https://arxiv.org/abs/2510.12959) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Md Aminul Islam, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 17 | [A Simulation Framework for Studying Systemic Effects of Feedback Loops in Recommender Systems](https://arxiv.org/abs/2510.14857) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Gabriele Barlacchi, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 18 | [CTRL-Rec: Controlling Recommender Systems With Natural Language](https://arxiv.org/abs/2510.12742) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Micah Carroll, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 19 | [Next Interest Flow: A Generative Pre-training Paradigm for Recommender Systems by Modeling All-domain Movelines](https://arxiv.org/abs/2510.11317) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Chen Gao, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
| 20 | [SMILE: SeMantic Ids Enhanced CoLd Item Representation for Click-through Rate Prediction in E-commerce SEarch](https://arxiv.org/abs/2510.12604) <br/> 论文核心：CRSs评估的局限性与用户模拟的潜力                                         | Qihang Zhao, 2025   |  ✅ 已读   |       [笔记](notes/2510/2-week/011-CRSs.md)        |
