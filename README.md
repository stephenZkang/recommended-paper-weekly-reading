...
| 2 | [MIRA: Empowering One-Touch AI Services on Smartphones with MLLM-based Instruction Recommendation](https://arxiv.org/abs/2509.13773)  <br/>  GenPAS（生成式推荐序列数据增强框架）   | Zhipeng Bian,<br /> 2025                          | ✅ 已读  |     [笔记](notes/2509/3-week/002-genPAS.md)      |
